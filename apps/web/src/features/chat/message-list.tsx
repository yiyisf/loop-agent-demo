...
function UserMessage({ message }: { message: AgentUIMessage }) {
  ...
  return (
    <div className="flex justify-end" data-testid="user-message">
      <div className="max-w-[85%] min-w-0 rounded-2xl rounded-br-md bg-primary px-4 py-2.5 text-sm break-all whitespace-pre-wrap [overflow-wrap:anywhere] text-primary-foreground">
        {text}
      </div>
    </div>
  );
